...
from .temporal_ms_deform_transformer.temporal_transformer import build_temporal_transformer
from .cva_net import DETRsegm, SetCriterion, PostProcess, PostProcessPanoptic, PostProcessSegm
from .matcher import build_matcher


class TemporalMSDeformDETR(DeformableDETR):
    def __init__(
            self,
            backbone,
            transformer,
        ...
        super(TemporalMSDeformDETR, self).__init__(
            backbone,
            transformer,
            num_classes,
            num_queries,
    ...
    def forward(self, samples: NestedTensor):
        ...
        # samples.tensors = samples.tensors.squeeze(0)  # f, c, h, w
        bs, f, c, h, w = samples.tensors.shape   # TODO How to make it batch?
