...
from datasets.coco_clip import build_dataset
from engines.clip_predict_engine import evaluate
from engine import train_one_epoch
from models.clip_output.triple_branch_baseline import build as build_model
...
def get_args_parser():
    ...
    parser.add_argument('--num_support_frames_testing', default=2, type=int)
...
def main(args):
    ...
    data_loader_train = DataLoader(dataset_train,
                                   ...
                                   collate_fn=utils.collate_fn_for_clip,
